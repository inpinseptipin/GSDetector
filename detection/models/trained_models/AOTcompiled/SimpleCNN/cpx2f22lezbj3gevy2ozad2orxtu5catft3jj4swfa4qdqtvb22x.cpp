...
{
    {
        ...
        for(long x0=static_cast<long>(0L); x0<static_cast<long>(4L); x0+=static_cast<long>(1L))
        {
            ...
            auto tmp4 = tmp0 < tmp3;
            auto tmp5 = static_cast<float>(-0.058462053537368774);
            auto tmp6 = static_cast<float>(-0.1369132697582245);
            auto tmp7 = tmp4 ? tmp5 : tmp6;
            auto tmp8 = static_cast<long>(3);
            auto tmp9 = tmp0 < tmp8;
            auto tmp10 = static_cast<float>(0.1505213975906372);
            auto tmp11 = static_cast<float>(-0.23625881969928741);
                       ...
                       float* out_ptr2)
{
    ...
    }
    {
        ...
        for(long x0=static_cast<long>(0L); x0<static_cast<long>(8L); x0+=static_cast<long>(1L))
        {
            ...
            auto tmp6 = tmp0 < tmp5;
            auto tmp7 = static_cast<float>(0.16290803253650665);
            auto tmp8 = static_cast<float>(-0.11846711486577988);
            auto tmp9 = tmp6 ? tmp7 : tmp8;
            auto tmp10 = static_cast<long>(3);
            auto tmp11 = tmp0 < tmp10;
            auto tmp12 = static_cast<float>(-0.044865913689136505);
            auto tmp13 = static_cast<float>(0.0576351135969162);
            ...
            auto tmp20 = static_cast<float>(0.09650277346372604);
            auto tmp21 = static_cast<float>(0.14814572036266327);
            auto tmp22 = tmp19 ? tmp20 : tmp21;
            auto tmp23 = static_cast<long>(7);
            auto tmp24 = tmp0 < tmp23;
            auto tmp25 = static_cast<float>(-0.02315361611545086);
            auto tmp26 = static_cast<float>(-0.06405476480722427);
...
#include "/var/folders/zs/vx_6lqwd1cx250x_47lxr10r0000gn/T/torchinductor_scottpyle/wy/cwyvgno7oj63mpe36f4v6pizgeyvccmavffogp6xnqv56a32gbwo.h"
extern "C" void cpp_fused_addmm_sigmoid_2(float* in_out_ptr0,
                       const float* in_ptr0,
                       const float* in_ptr1)
{
    ...
    }
    {
        ...
        auto tmp3 = static_cast<float>(0.014626123011112213);
...
void AOTInductorModel::run_impl(
    ...
    cpp_fused_addmm_sigmoid_2((float*)(buf7.data_ptr()), (float*)(buf5.data_ptr()), (float*)(L__self___fc_weight.data_ptr()));
