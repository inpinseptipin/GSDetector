...
{
    {
        ...
        for(long x0=static_cast<long>(0L); x0<static_cast<long>(4L); x0+=static_cast<long>(1L))
        {
            ...
            auto tmp4 = tmp0 < tmp3;
            auto tmp5 = static_cast<float>(-0.05125392600893974);
            auto tmp6 = static_cast<float>(-0.16940271854400635);
            auto tmp7 = tmp4 ? tmp5 : tmp6;
            auto tmp8 = static_cast<long>(3);
            auto tmp9 = tmp0 < tmp8;
            auto tmp10 = static_cast<float>(0.3270041346549988);
            auto tmp11 = static_cast<float>(-0.08016885071992874);
                       ...
                       float* out_ptr2)
{
    ...
    }
    {
        ...
        for(long x0=static_cast<long>(0L); x0<static_cast<long>(8L); x0+=static_cast<long>(1L))
        {
            ...
            auto tmp6 = tmp0 < tmp5;
            auto tmp7 = static_cast<float>(0.2089991271495819);
            auto tmp8 = static_cast<float>(-0.17276036739349365);
            auto tmp9 = tmp6 ? tmp7 : tmp8;
            auto tmp10 = static_cast<long>(3);
            auto tmp11 = tmp0 < tmp10;
            auto tmp12 = static_cast<float>(-0.08875566720962524);
            auto tmp13 = static_cast<float>(0.18851155042648315);
            ...
            auto tmp20 = static_cast<float>(0.1488827019929886);
            auto tmp21 = static_cast<float>(0.21429595351219177);
            auto tmp22 = tmp19 ? tmp20 : tmp21;
            auto tmp23 = static_cast<long>(7);
            auto tmp24 = tmp0 < tmp23;
            auto tmp25 = static_cast<float>(-0.030388250946998596);
            auto tmp26 = static_cast<float>(-0.13006815314292908);
                       ...
                       const float* in_ptr1)
{
    ...
    }
    {
        ...
        auto tmp3 = static_cast<float>(-0.030596164986491203);
