...
{
    {
        ...
        for(long x0=static_cast<long>(0L); x0<static_cast<long>(4L); x0+=static_cast<long>(1L))
        {
            ...
            auto tmp4 = tmp0 < tmp3;
            auto tmp5 = static_cast<float>(-0.044468801468610764);
            auto tmp6 = static_cast<float>(-0.10880480706691742);
            auto tmp7 = tmp4 ? tmp5 : tmp6;
            auto tmp8 = static_cast<long>(3);
            auto tmp9 = tmp0 < tmp8;
            auto tmp10 = static_cast<float>(0.159005269408226);
            auto tmp11 = static_cast<float>(-0.22089649736881256);
                       ...
                       float* out_ptr2)
{
    ...
    }
    {
        ...
        for(long x0=static_cast<long>(0L); x0<static_cast<long>(8L); x0+=static_cast<long>(1L))
        {
            ...
            auto tmp6 = tmp0 < tmp5;
            auto tmp7 = static_cast<float>(0.1824488341808319);
            auto tmp8 = static_cast<float>(-0.09978737682104111);
            auto tmp9 = tmp6 ? tmp7 : tmp8;
            auto tmp10 = static_cast<long>(3);
            auto tmp11 = tmp0 < tmp10;
            auto tmp12 = static_cast<float>(-0.04164593666791916);
            auto tmp13 = static_cast<float>(0.06858734041452408);
            ...
            auto tmp20 = static_cast<float>(0.09280825406312943);
            auto tmp21 = static_cast<float>(0.15363384783267975);
            auto tmp22 = tmp19 ? tmp20 : tmp21;
            auto tmp23 = static_cast<long>(7);
            auto tmp24 = tmp0 < tmp23;
            auto tmp25 = static_cast<float>(0.0003433710371609777);
            auto tmp26 = static_cast<float>(-0.051976148039102554);
                       ...
                       const float* in_ptr1)
{
    ...
    }
    {
        ...
        auto tmp3 = static_cast<float>(0.011226261965930462);
